...
var TableSorter = React.createClass({
  ...
  componentWillMount: function () {
    ...
    $(document).ready(function(){
      ...
      source.addEventListener('messages.create', function(e) {
        ...
        summaryColumn=that.findColumnByPrizeID(that.state.summary,message['prize']['_id']);
        ...
        new PNotify({
          title: '獎項更新',
          text: summaryColumn['_id']+"獎： "+summaryColumn['name']+' \n得獎人：'+summaryColumn['staff_id']+"  "+summaryColumn['staff_name'],
          hide: false
        });
      });
    });
  ...
  handleEditSubmit: function (event) {
    ...
    this.register(stuff_id.toUpperCase(),prize_id,"Edit prize");
  },
...
if(document.getElementById("check_prizes")){
  ...
  React.renderComponent(<App />, document.getElementById("check_prizes"));
}
